<?php
namespace blobfolio\wp\wh\vendor\TijsVerkoyen\CssToInlineStyles;
use \blobfolio\wp\wh\vendor\Symfony\Component\CssSelector\CssSelector;
use \blobfolio\wp\wh\vendor\Symfony\Component\CssSelector\CssSelectorConverter;
use \blobfolio\wp\wh\vendor\Symfony\Component\CssSelector\Exception\ExceptionInterface;
use \blobfolio\wp\wh\vendor\TijsVerkoyen\CssToInlineStyles\Css\Processor;
use \blobfolio\wp\wh\vendor\TijsVerkoyen\CssToInlineStyles\Css\Property\Processor as PropertyProcessor;
use \blobfolio\wp\wh\vendor\TijsVerkoyen\CssToInlineStyles\Css\Rule\Processor as RuleProcessor;
use \blobfolio\wp\wh\vendor\TijsVerkoyen\CssToInlineStyles\Css\Rule\Rule;
...
class CssToInlineStyles
{
    ...
    {
        if (class_exists('blobfolio\\wp\\wh\\vendor\\Symfony\Component\CssSelector\CssSelectorConverter')) {
