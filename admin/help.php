...
// Our help files.
$Parsedown = new \blobfolio\wp\wh\vendor\md\Parsedown();
$help = array(
...
$data = array(
	'help'=>\blobfolio\wp\wh\vendor\common\format::array_to_indexed($help),
	'links'=>$links,
	'showingHelp'=>$first
);
...
<div class="wrap" id="vue-help" data-env="<?php echo esc_attr(json_encode($data, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT)); ?>" v-cloak>
	<h1><?php echo esc_html__('Well-Handled: Help', 'well-handled'); ?></h1>
	...
	<div id="poststuff">
		<div id="post-body" class="metabox-holder wh-columns one-two fixed">
			...
			<div class="postbox-container one">
				...
				=============================================== -->
				<div class="postbox">
					<h3 class="hndle"><?php echo esc_html__('Quick Links', 'well-handled'); ?></h3>
					<div class="inside">
